...
/**
 * First-run walkthrough shown when no artifacts exist in the current session.
 * Three cards explain the three primitives the user most needs to recognize:
 *   1. Concept naming in reasoning artifacts — the teaching mechanic
 *   2. Ask-why on any content — conversational pairing
 *   3. Session memory — what the agent won't re-propose
 *
 * Kept intentionally minimal: no animations, no dismiss, no state. When the
 * first real artifact arrives the panel replaces this naturally.
 */
function FirstRunWalkthrough() {
  return (
    <div className="flex flex-col items-center justify-center h-full p-6 gap-4 overflow-y-auto">
      ...
      <div className="grid grid-cols-1 min-[900px]:grid-cols-3 gap-2.5 w-full max-w-2xl mt-2">
