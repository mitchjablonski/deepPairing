    ...
    tools: [
      ...
      },
      {
        ...
        description:
          ...
          "\n\nScoped drill-in (O1 #229): when check_feedback delivers an explain-intent request the human raised by clicking \"walk me through this\" on a specific changeset hunk or needs-your-eyes item, it carries that file/hunk context — scope the explainer to THAT hunk/item (a focused walk of just those lines, anchored to that Evidence), NOT a whole-codebase tour. Pass servedRequestId so it links back and clears. Still pull-first: the human asked; answer exactly what they pointed at, at that grain." +
